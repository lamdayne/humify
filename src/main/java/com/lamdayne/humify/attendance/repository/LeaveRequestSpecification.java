...
public class LeaveRequestSpecification {
    ...
    public Specification<LeaveRequest> build(List<SpecSearchCriteria> criteriaList) {
        ...
        GenericSpecificationBuilder<LeaveRequest> builder = new GenericSpecificationBuilder<>();
