...
public interface PayslipService {
    ...
    PayslipResponse updatePayslip(Long payslipId, UpdatePayslipRequest request);

    /** GET /employees/my-payslips — nhân viên tự tra cứu, chỉ thấy SENT/PAID. */
    PageResponse<MyPayslipResponse> getMyPayslips(Long employeeId, Integer year, int page, int size, String... sorts);
}
